...
const AboutUs = () => {
  return (
    <div className='flex items-center flex-col md:flex-row gap-3 border border-[rgba(38,37,34,0.24)] rounded-4xl p-4 w-full h-full'>
      <div className='flex flex-col items-center gap-3'>
        <div className='flex flex-col md:flex-row items-start w-full h-full '>
          <div className='flex flex-col items-start justify-center  child:block space-y-3 text-left h-1/2 mt-12'>
            ...
            <h5 className='text-[40px] font-montserrat font-bold child:block uppercase leading-10'>
              Our Culinary<span>Chronicle</span>
            </h5>
            <span className='text-[rgba(38,37,34,0.6)] font-light font-roboto w-4/5 leading-[140%] text-justify'>
      ...
      <div className='md:h-[665px] w-full md:max-w-[412px]'>
        <Image
          width={700}
          height={700}
          src={"/images/AboutusImage.jpg"}
          alt='about us image'
          className=' object-cover h-[324px] md:h-full rounded-3xl'
        />
      </div>
    </div>
  );
